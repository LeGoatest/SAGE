...
**Classify every request into a TASK_GROUP before proceeding.**
**Use Spec Mode (.jtasks) for all non-trivial feature development.**
**Always respect canonical precedence hierarchy.**
**Prompts MUST NOT override canon resolution.**

---

This ensures the Agent immediately adopts the Sovereign governance model using the external Repo of Truth.
